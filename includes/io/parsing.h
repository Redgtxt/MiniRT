...
bool		parse_texture(t_control_panel *control_panel, char **element_info,
				t_error_log *error_log);
bool		load_all_textures(t_control_panel *control_panel);
t_texture	*get_texture_by_id(t_control_panel *control_panel, int id);
...
bool		parse_cone_checks(t_cone *cone, char **element_info,
				t_error_log *err);
void		parse_element_2(t_control_panel *control_panel,
				char **element_info);
