...
void			vec3_multiply(double out[3], const double a[3],
					const double b[3]);
...
void			vec3_sub_chain(double out[3], const double a[3],
...
void			vec3_add_scaled(double out[3], const double a[3],
					const double b[3], double s);
