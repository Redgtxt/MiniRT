...
SRC_FILES = main.c \
	...
	$(addprefix parsing/, parsing.c parse_elements.c parse_objects.c parse_values_1.c parse_values_2.c parse_values_utils.c init_element_array.c initialization.c parse_texture.c texture_loader.c free_texture_list.c parse_object_utils.c) \
