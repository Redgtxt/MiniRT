...
SRC_FILES = main.c \
	    ...
	    $(addprefix Mlx/, hooks.c mlx_utils.c mlx_antialising.c mlx_brightness.c control_window.c mlx_init_values.c mouse_hooks.c buttons.c sliders.c mouse_handler_utils.c click_objects.c)  \
