...
static int	plane_t_check(t_plane_vars *vars, t_plane *plane,
...
bool	have_hit_plane(t_plane *plane, const t_ray *ray,
...
bool	hit_planes(t_control_panel *scene, const t_ray *ray,
					t_interval t_ray, t_hit_record *record)
{
    bool hit_anything;
    ...
    {
        if (have_hit_plane(&scene->plane[i], ray,
