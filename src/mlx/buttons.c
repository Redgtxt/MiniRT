...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/05 13:54:26 by hguerrei          #+#    #+#             */
/*   Updated: 2025/08/05 14:01:50 by hguerrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	pixel_put_win_control(t_control_panel *cp, int x, int y, int color)
{
	...
	{
		dst = control_data->addr + (y * control_data->line_length + x
				* (control_data->bits_per_pixel / 8));
