...
/*   Updated: 2025/06/11 17:40:48 by hguerrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void setup_camera_dimensions(t_control_panel *control_panel)
{
	...
	control_panel->camera.pixel_samples_scale = control_panel->camera.samples_per_pixel / 1;
...
int main(int argc, char *argv[])
{
	...
	while (y < control_panel->camera.image_height)
	{
        ...
        if (y % 10 == 0)
            ft_printf("\rScanlines remaining: %d ", (control_panel->camera.image_height - y));
